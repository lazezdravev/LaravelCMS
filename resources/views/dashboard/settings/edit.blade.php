    ...
    <div class="row">
        <div class="col-12 mb-3 mb-lg-5">
            <div class="card h-100">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img src="/assets/img/settings/medium/{{ $settings->image }}" alt="{{ $settings->title }}" class="img-responsive" style="max-width: 200px;"/>
                    </div>
                </div>
                <div class="card-body">
                    <form class="row g-3" method="post" action="{{ route('settings.update', $settings->id ) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" id="description" placeholder="Textarea"
                                      class="form-control quill-editor">{{ $settings->description }}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-12 col-md-12 mb-4">
                            ...
                            <a href="{{ route('settings.index') }}" class="btn btn-secondary mb-2 me-2">
                                                <span class="material-symbols-rounded align-middle me-2">
